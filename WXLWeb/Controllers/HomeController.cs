...
namespace WXLWeb.Controllers
{
    public class HomeController : Controller
    {
        //
        // GET: /Home/
        private IWXL_ArticleBll _bll;
        public HomeController(IWXL_ArticleBll Bll)
        {
            _bll = Bll;
        }
        public ActionResult Test()
        {
            List<WXL_Article> users = _bll.LoadEntities(a => true).ToList();
            return Content("test");
        }
        public ActionResult Index()
        {
            ...
            int total;
            //取前10条
            var articles = _bll.LoadPageEntities(1, 10, out total, a => true, a => a.CreateTime, false)
                .ToList()
                .Select(a => new WXL_Article { ArticleId = a.ArticleId, Title = a.Title })
                .ToList();

            indexView.newArticles = articles;
