...
$.AdminLTE.layout = {
  ...
  fix: function () {
    ...
    if ($("body").hasClass("fixed")) {
        //加多.content-txt内容高度
        $(".content-wrapper, .right-side, .content-txt").css('min-height', window_height - $('.main-footer').outerHeight());
        //加多iframe的高度
        $("#menuFrame").css('min-heigth', window_height - $('.main-footer').outerHeight()-7);
    } else {
      if (window_height >= sidebar_height) {
          $(".content-wrapper, .right-side, .content-txt").css('min-height', window_height - neg);
          $("#menuFrame").css('min-height', window_height - neg-7);
      } else {
          $(".content-wrapper, .right-side, .content-txt").css('min-height', sidebar_height);
          $("#menuFrame").css('min-heigth', sidebar_height-7);
      }
    }
  },
  fixSidebar: function () {
